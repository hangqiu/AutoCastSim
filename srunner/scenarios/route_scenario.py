...
from srunner.scenarios.autocast_maneuver_opposite_direction import AutoCastManeuverOppositeDirection
from srunner.scenarios.autocast_red_light_violation import AutoCastIntersectionRedLightViolation
from srunner.scenarios.autocast_unprotected_left_turn import AutoCastIntersectionUnprotectedLeftTurn
from srunner.scenarios.autocast_test import AutoCastTest


MAX_ALLOWED_RADIUS_SENSOR = 5.0
SECONDS_GIVEN_PER_METERS = 2 # was 0.4
...
NUMBER_CLASS_TRANSLATION = {
    ...
    "AutoCast6": AutoCastManeuverOppositeDirection,
    "AutoCast8": AutoCastIntersectionUnprotectedLeftTurn,
    "AutoCast10": AutoCastIntersectionRedLightViolation,
    "AutoCastTest": AutoCastTest,
}
...
class RouteScenario(BasicScenario):
    ...
    def _build_background_scenario(self, world, ego_vehicle, town_name, timeout=300, debug_mode=False):
        ...
        # overwriting if user defined
        if Utils.BACKGROUND_TRAFFIC is not None:
            amount = Utils.BACKGROUND_TRAFFIC
