...
class CarlaDataProvider(object):  # pylint: disable=too-many-public-methods
    ...
    _rng = random.RandomState(2000) # 0.9.10 fixed seed for random traffic
    ...
    def set_traffic_manager_port(tm_port):
        ...
        CarlaDataProvider._traffic_manager = CarlaActorPool.get_client().get_trafficmanager(tm_port)
    ...
    def get_transform(actor):
        ...
        """
        # TODO: check and replace all get_transform to reduce interaction with carla engine
    ...
    @staticmethod
    def get_vehicles():
        CarlaDataProvider._world.get_actors().filter("*vehicle*")
