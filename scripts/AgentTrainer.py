...
class AgentTrainer(object):
    ...
    def init_agent(self, mem_length):
        ...
        # if self._model_name==PIXOR:
            ...
            # self._agent = PIXOR_MODEL(input_dim, n_action=3, batch_size=self._batch_size, epoch=self._epoch)
...
if __name__ == "__main__":
    ...
    trainer = AgentTrainer(ARGUMENTS.train, ARGUMENTS.val, ARGUMENTS.model, mem_length=MEM_LENGTH, epoch=300)
